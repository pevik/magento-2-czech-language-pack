# How to contribute Czech Language pack
...
- [github_contributions.csv](https://github.com/mageplaza/magento-2-czech-language-pack/blob/master/github_contributions.csv) has been contributed by Mageplaza and Magento community.

- We will merge `github_contributions.csv` with [cs_CZ.csv](https://github.com/mageplaza/magento-2-czech-language-pack/blob/master/cs_CZ.csv). Your Magento 2 store will use this csv file.

So, you should contribute to [github_contributions.csv](https://github.com/mageplaza/magento-2-czech-language-pack/blob/master/github_contributions.csv) file.
...
#### Suggestions
- You can copy any part of `cs_CZ.csv` and paste to `github_contributions.csv` then translate it.
- Please do not copy all lines in `cs_CZ.csv`, we will not approve it in this case.
