...
![Mageplaza Czech language pack](https://cdn3.mageplaza.com/media/general/qjWPj1W.png)
...
![Czech language pack process](https://progress-bar.dev//?title=completed)
...
```
composer require mageplaza/magento-2-czech-language-pack:dev-master avada/module-proofo
...
## 3. How to Active the Czech language pack 
